...
return [
    ...
    */
    ...
    'slack_webhook_url' => env('SLACK_WEBHOOK_URL', 'https://hooks.slack.com/services/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'),
    ...
    */
    ...
    'application_name' => env('APP_NAME', 'isa-project'),
